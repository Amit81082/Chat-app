          ...
          {allUserConv.map((conv, index) => {
            return (
              <NavLink
                ...
                key={conv?._id}
                className="flex items-center gap-2 py-3 px-3 border border-transparent hover:border-primary rounded hover:bg-slate-100 cursor-pointer"
              >
                <div>
                  <Avatar
